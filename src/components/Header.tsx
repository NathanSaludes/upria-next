    ...
    <header className="container relative flex justify-center font-sans">
      <div className="container fixed z-50 flex justify-between rounded-b-2xl border border-t-0 bg-white px-4 py-4 shadow-sm">
        ...
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
              <NavigationMenuTrigger>Buy Real Estate</NavigationMenuTrigger>
              <NavigationMenuContent>
                <ul className="flex min-w-[200px] flex-col p-3 pb-2.5">
                  <li>
                    <NavigationMenuLink asChild>
                      <CustomMenuLink href="#">House and Lot</CustomMenuLink>
                    </NavigationMenuLink>
                  </li>
                  <li>
                    <NavigationMenuLink asChild>
                      <CustomMenuLink href="#">Condominiums</CustomMenuLink>
                    </NavigationMenuLink>
                  </li>
                  <li>
                    <NavigationMenuLink asChild>
                      <CustomMenuLink href="#">Apartments</CustomMenuLink>
                    </NavigationMenuLink>
                  </li>
                  <li>
                    <NavigationMenuLink asChild>
                      <CustomMenuLink href="#">Townhouses</CustomMenuLink>
                    </NavigationMenuLink>
                  </li>
                  <li>
                    <NavigationMenuLink asChild>
            ...
            <NavigationMenuItem>
              <NavigationMenuTrigger>Rental Properties</NavigationMenuTrigger>
            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <ul className="flex min-w-[200px] flex-col p-3 pb-2.5">
                  <li>
                    <NavigationMenuLink asChild>
                      <CustomMenuLink href="#">News & Blog</CustomMenuLink>
                    </NavigationMenuLink>
                  </li>
                  <li>
                    <NavigationMenuLink asChild>
                      <CustomMenuLink href="#">Careers</CustomMenuLink>
                    </NavigationMenuLink>
                  </li>
                  <li>
                    <NavigationMenuLink asChild>
                      <CustomMenuLink href="#">About Us</CustomMenuLink>
                    </NavigationMenuLink>
                  </li>
                  <li>
                    <NavigationMenuLink asChild>
                      <CustomMenuLink href="#">Help Center</CustomMenuLink>
                    </NavigationMenuLink>
                  </li>
                </ul>
              </NavigationMenuContent>
